#ifndef __ARCH_SH4_E88_H__
#define	__ARCH_SH4_E88_H__
 ...
 */
#define SWITCH_TASK  __asm__ __volatile__ ("INT $48")
...
/**
  ...
  * wywo³aniem
  */
#define INT_DISABLE(x)    __asm__ __volatile__ ("pushfl");\
...
/** W³¹czanie przerwañ
  ...
  * x86 - EFLAGS.
  */
#define INT_ENABLE(x) __asm__ __volatile__ ("pushl %0; popfl"::"g"(x))
